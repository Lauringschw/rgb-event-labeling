...
if __name__ == "__main__":
    print("=" * 55)
    print("TEST SAMPLE EXTRACTION — Histogram Fixed (RQ1 + RQ2)")
    print("=" * 55)

    # load test recording IDs saved by extract_samples_histogram_fixed.py
    test_ids_path = OUTPUT_DIR / "test_recording_ids.npy"
    if not test_ids_path.exists():
        raise FileNotFoundError(
            f"Missing: {test_ids_path}\n"
            f"Run extract_samples_histogram_fixed.py first.")
    ...
    print("Next: run evaluate_histogram_fixed.py")
